...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Task&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.done, done) || other.done == done)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}
...
@override
String toString() {
  return 'Task(id: $id, title: $title, done: $done, updatedAt: $updatedAt)';
}
...
class _Task implements Task {
  const _Task({required this.id, required this.title, this.done = false, this.updatedAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Task&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.done, done) || other.done == done)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}
